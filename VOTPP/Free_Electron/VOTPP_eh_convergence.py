...
np.savetxt('electron_hydrogen_convergence_order.dat', np.column_stack((timespace_absolute, Mx_order[0], Mx_order[1])))
np.savetxt('electron_hydrogen_convergence_bath.dat', np.column_stack((timespace_absolute, Mx_bath[0], Mx_bath[1], Mx_bath[2], Mx_bath[3])))
np.savetxt('electron_hydrogen_convergence_dipole.dat', np.column_stack((timespace_absolute, Mx_dipole[0], Mx_dipole[1], Mx_dipole[2])))
