...
class BathSetup:
    ...
    def populate_cell(self, N, x, y, z, bath_type):
        ...
        if bath_type=='electronic':
            ...
            self.sic.add_atoms((N[154], [x[154], y[154], z[154]]), type='angstrom')
            ...
            if bath_type=='hydrogen':
                ...
                # Set isotope concentration
                self.sic.isotopes['C']['13C'] = 0.011100000000000001
                # Set spin types
                self.spin_types = [
                            '13C',  1/2,  6.72828,
                            ]
...
timespace_absolute = np.linspace(0, 1e-3, 2001)
...
for i in range(3):
    ...
    for j in range(len(timespace_absolute)):
        ...
        Mx_sums.append(Mx_sum/len(seeds))
    Mx_order_av_ee.append(Mx_sums)
...
for i in range(4):
    ...
    for j in range(len(timespace_absolute)):
        ...
        Mx_sums.append(Mx_sum/len(seeds))
    Mx_dipole_av_ee.append(Mx_sums)

np.savetxt('electron_electron_convergence_order.dat', np.column_stack((timespace_absolute, Mx_order_av_ee[0], Mx_order_av_ee[1], Mx_order_av_ee[2])))
np.savetxt('electron_electron_convergence_bath.dat', np.column_stack((timespace_absolute, Mx_bath_av_ee[0], Mx_bath_av_ee[1], Mx_bath_av_ee[2], Mx_bath_av_ee[3])))
np.savetxt('electron_electron_convergence_dipole.dat', np.column_stack((timespace_absolute, Mx_dipole_av_ee[0], Mx_dipole_av_ee[1], Mx_dipole_av_ee[2], Mx_dipole_av_ee[3])))