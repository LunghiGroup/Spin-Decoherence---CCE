...
timespace = np.linspace(0, 2e-4, 2001)
...
Mx_be = []
np.random.seed(8800)
seeds = list(np.random.randint(low=1,high=99999,size=35))
for seed in seeds:
...
np.savetxt('both_electron_concentrations15.dat', np.column_stack((timespace,Mx_av_be)))