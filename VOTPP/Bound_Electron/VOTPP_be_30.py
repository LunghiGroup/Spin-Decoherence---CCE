...
timespace = np.linspace(0, 7e-5, 2001)
...
Mx_be = []
np.random.seed(8800)
seeds = list(np.random.randint(low=1,high=99999,size=17))
for seed in seeds:
...
np.savetxt('both_electron_concentrations30.dat', np.column_stack((timespace,Mx_av_be)))