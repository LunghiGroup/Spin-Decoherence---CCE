...
for i in range(2):
    ...
    for j in range(len(timespace_absolute)):
        ...
        Mx_sums.append(Mx_sum/nsamples)
...
np.savetxt('both_electron_convergence_order_ET_5.dat', np.column_stack((timespace_absolute, Mx_order_av_be[0], Mx_order_av_be[1])))
np.savetxt('both_electron_convergence_bath_ET_5.dat', np.column_stack((timespace_absolute, Mx_bath_av_be[0], Mx_bath_av_be[1], Mx_bath_av_be[2], Mx_bath_av_be[3])))
np.savetxt('both_electron_convergence_dipole_ET_5.dat', np.column_stack((timespace_absolute, Mx_dipole_av_be[0], Mx_dipole_av_be[1], Mx_dipole_av_be[2])))