...
np.savetxt('electron_electron_convergence_order.dat', np.column_stack((timespace_absolute, Mx_order[0], Mx_order[1], Mx_order[2])))
np.savetxt('electron_electron_convergence_bath.dat', np.column_stack((timespace_absolute, Mx_bath[0], Mx_bath[1], Mx_bath[2], Mx_baths[3])))
np.savetxt('electron_electron_convergence_dipole.dat', np.column_stack((timespace_absolute, Mx_dipole[0], Mx_dipole[1], Mx_dipole[2], Mx_dipole[3])))