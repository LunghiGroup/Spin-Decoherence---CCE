...
timespace = np.linspace(0, 1.5e-2, 500)
...
Mx_ee = []
np.random.seed(8800)
seeds = list(np.random.randint(low=1,high=99999,size=43))
for seed in seeds:
...
np.savetxt('electron_electron_pulses_30_1536.dat', np.column_stack((timespace, Mx_av_ee)))
