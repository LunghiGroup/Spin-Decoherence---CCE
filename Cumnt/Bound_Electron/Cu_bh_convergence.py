...
default_bath_parameters = {
    'filepath': '/home/users/ryanc70/PyCCE/Cu/Cu.xyz',
...
np.savetxt('both_hydrogen_convergence_bath_ET.dat', np.column_stack((timespace_absolute, Mx_bath[0], Mx_bath[1], Mx_bath[2], Mx_bath[3])))
np.savetxt('both_hydrogen_convergence_dipole_ET.dat', np.column_stack((timespace_absolute, Mx_dipole[0], Mx_dipole[1], Mx_dipole[2], Mx_dipole[3])))